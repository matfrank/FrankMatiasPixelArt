...
function mostrarGrilla (){
  for (var i=1750 ; i>grilla.length; i--){
...
function pintarPixel(e){
  console.log(e)
  //paleta.style.backgroundColor = e.target.style.backgroundColor; 
  grillaPixeles.style.backgroundColor = e.target.style.backgroundColor;
}